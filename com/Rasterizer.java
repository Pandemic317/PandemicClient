...
public final class Rasterizer extends DrawingArea {
	...
	public static void drawMaterializedTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2,
		...
		if (!Constants.enableHDTextures || Texture.get(tex) == null) {
			drawShadedTriangle(y1, y2, y3, x1, x2, x3, hsl1, hsl2, hsl3, z1, z2, z3);
			return;
		}
		...
		if (x1 < x2) {
			...
			if (anInt1465 == 0) {
				...
				while (--n >= 0) {
					...
					dst = dest[offset];
					depth = DrawingArea.depthBuffer[offset];
					if (true) {
	...
	public static void drawFlatTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int k1, float z1, float z2,
			float z3) {
		if (z1 < 0.0F || z2 < 0.0F || z3 < 0.0F) {
			return;
		}
	...
	public static void drawTexturedTriangle(int y_a, int y_b, int y_c, int x_a, int x_b, int x_c, int l1, int l2,
			int l3, int tx1, int tx2, int tx3, int ty1, int ty2, int ty3, int tz1, int tz2, int tz3, int tex, float z1,
			float z2, float z3) {
		try {
			if (z1 < 0.0F || z2 < 0.0F || z3 < 0.0F) {
				return;
