...
public final class RSInterface {
	...
	public static void overlayListener(TextDrawingArea[] tda) {
		addText(35000, "", tda, 0, 0, false, true);
	}
	...
	public static void Skillcapes(TextDrawingArea[] TDA) {
		...
		addHoveredButton(29562, "Interfaces/Skillcapes/CLOSE", 2, 16, 16, 29563);// CLOSE
		// HOVER
	...
	public static void Loyalty(TextDrawingArea[] tda) {
		...
		addText(12226, "Pandemic Loyalty Points", 0xff9b00, false, true, 38, tda, 1); // defaultpointhandling
	...
	public static void Bosses(TextDrawingArea[] tda) {
		...
		addHoverButton(42003, "Interfaces/Bosses/BUTTON", 1, 65, 70, "Godwars Dungeon", -1, 42004, 1);
		addHoveredButton(42004, "Interfaces/Bosses/BUTTON", 0, 65, 70, 42005);
		addHoverButton(42005, "Interfaces/Bosses/BUTTON", 2, 65, 70, "Nex", -1, 42006, 1);
		addHoveredButton(42006, "Interfaces/Bosses/BUTTON", 0, 65, 70, 42007);
		addHoverButton(42007, "Interfaces/Bosses/BUTTON", 3, 65, 70, "King Black Dragon", -1, 42008, 1);
		addHoveredButton(42008, "Interfaces/Bosses/BUTTON", 0, 59, 49, 42009);
		addHoverButton(42009, "Interfaces/Bosses/BUTTON", 4, 59, 49, "Corporal Beast", -1, 42010, 1);
		addHoveredButton(42010, "Interfaces/Bosses/BUTTON", 0, 58, 49, 42011);
		addHoverButton(42011, "Interfaces/Bosses/BUTTON", 5, 58, 49, "Kalphite Queen", -1, 42012, 1);
		addHoveredButton(42012, "Interfaces/Bosses/BUTTON", 0, 57, 49, 42013);
		addHoverButton(42013, "Interfaces/Bosses/BUTTON", 6, 57, 49, "Tormented Demons", -1, 42014, 1);
		addHoveredButton(42014, "Interfaces/Bosses/BUTTON", 0, 57, 48, 42015);
		addHoverButton(42015, "Interfaces/Bosses/BUTTON", 7, 57, 48, "Mad Mummy", -1, 42016, 1);
		addHoveredButton(42016, "Interfaces/Bosses/BUTTON", 0, 57, 48, 42017);
		addHoverButton(42017, "Interfaces/Bosses/BUTTON", 8, 57, 48, "Barrelchest", -1, 42018, 1);
		addHoveredButton(42018, "Interfaces/Bosses/BUTTON", 0, 57, 48, 42019);
		addHoverButton(42019, "Interfaces/Bosses/BUTTON", 9, 57, 48, "Forgotten Warrior", -1, 42020, 1);
		addHoveredButton(42020, "Interfaces/Bosses/BUTTON", 0, 57, 48, 42021);
		addHoverButton(42021, "Interfaces/Bosses/BUTTON", 10, 57, 48, "Giant Mole", -1, 42022, 1);
		addHoveredButton(42022, "Interfaces/Bosses/BUTTON", 0, 57, 47, 42023);
		addHoverButton(42023, "Interfaces/Bosses/BUTTON", 11, 57, 47, "Chaos Elemental", -1, 42024, 1);
	...
	public static void BossesTwo(TextDrawingArea[] tda) {
		...
		addHoverButton(45003, "Interfaces/BossesTwo/BUTTON", 1, 65, 70, "Wrecker", -1, 45004, 1);
		addHoveredButton(45004, "Interfaces/BossesTwo/BUTTON", 0, 65, 70, 45005);
		addHoverButton(45005, "Interfaces/BossesTwo/BUTTON", 2, 65, 70, "Protector", -1, 45006, 1);
		addHoveredButton(45006, "Interfaces/BossesTwo/BUTTON", 0, 65, 70, 45007);
		addHoverButton(45007, "Interfaces/BossesTwo/BUTTON", 3, 65, 70, "Pummeler", -1, 45008, 1);
		addHoveredButton(45008, "Interfaces/BossesTwo/BUTTON", 0, 59, 49, 45009);
		addHoverButton(45009, "Interfaces/BossesTwo/BUTTON", 4, 59, 49, "NMBeast", -1, 45010, 1);
	...
	public static void Pokemon(TextDrawingArea[] tda) {
		...
		addHoverButton(29561, "Interfaces/Skillcapes/CLOSE", 1, 16, 16, "Close", 0, 29562, 1);// CLOSE
		addHoveredButton(29562, "Interfaces/Skillcapes/CLOSE", 2, 16, 16, 36502);// CLOSE
		// HOVER
	...
	public static void Customs(TextDrawingArea[] tda) {
		...
		addHoverButton(29561, "Interfaces/Skillcapes/CLOSE", 1, 16, 16, "Close", 0, 29562, 1);// CLOSE
		addHoveredButton(29562, "Interfaces/Skillcapes/CLOSE", 2, 16, 16, 5503);// CLOSE
		// HOVER
		...
		addHoverButton(5512, "Interfaces/customs/BUTTON", 4, 59, 55, "Cape Of Pandemic", -1, 5513, 1);
	...
	public static void CustomsTwo(TextDrawingArea[] tda) {
		...
		addHoverButton(29561, "Interfaces/Skillcapes/CLOSE", 1, 16, 16, "Close", 0, 29562, 1);// CLOSE
		addHoveredButton(29562, "Interfaces/Skillcapes/CLOSE", 2, 16, 16, 43002);// CLOSE
		// HOVER
		...
		addHoverButton(43013, "Interfaces/CustomsTwo/BUTTON", 6, 59, 55, "Pandemic Battleaxe", -1, 43014, 1);// FirstLine
		addHoveredButton(43014, "Interfaces/CustomsTwo/BUTTON", 0, 59, 55, 43015);
		addHoverButton(43015, "Interfaces/CustomsTwo/BUTTON", 7, 59, 55, "Pandemic Godsword", -1, 43016, 1);
		addHoveredButton(43016, "Interfaces/CustomsTwo/BUTTON", 0, 59, 55, 43017);
		addHoverButton(43017, "Interfaces/CustomsTwo/BUTTON", 8, 59, 55, "Pandemic Kiteshield", -1, 43018, 1);
	...
	public static void CheevShop(TextDrawingArea[] tda) {
		...
		addHoverButton(29561, "Interfaces/Skillcapes/CLOSE", 1, 16, 16, "Close", 0, 29562, 1);// CLOSE
		addHoveredButton(29562, "Interfaces/Skillcapes/CLOSE", 2, 16, 16, 44002);// CLOSE
		// HOVER
	...
	public static void staffTab(TextDrawingArea[] tda) {
		...
		int index = 0;
		addText(28024, "Pandemic Staff", 0xff9933, true, true, -1, 1);
		...
		addText(28014, "Spots Open", 0xffffff, false, true, -1, 1);
		addText(28015, "Offline", 0xff0000, false, true, -1, 1);
		...
		tab.child(26, 28014, 3, 189);
		tab.child(27, 28015, 146, 189);
	...
	public static void extraEquipment(TextDrawingArea[] TDA) {
		...
		addText(27626, "Anywhere in Pandemic", 0xFF981F, false, true, 52, TDA, 1);
	...
	public static void infoTab(TextDrawingArea[] tda) {
		...
		addText(6203, "@lre@[@gre@0@lre@] Pandemic Points", tda, 0, 0xff9933, false, true);
		...
		addText(6211, "@lre@www.@gre@Pandemic@lre@.com", tda, 0, 0xff9933, true, true);
	...
	public static void questTab(TextDrawingArea[] TDA) {
		...
		try {
			setChildren(4, localRSInterface);
			addText(39266, "           Teleports", 16750623, false, true, -1, TDA, 2);
			addButton(39267, 2, "Interfaces/QuestTab/QUEST", 18, 18, "Swap to main menu", 1);
			...
			addHoverText(39295, "", "Players Online", TDA, 0, 16750623, false, true, 150);
			addHoverText(39296, "", "Home", TDA, 0, 16711680, false, true, 150);
			addHoverText(39297, "", "1B Tickets (Floor 1)", TDA, 0, 16711680, false, true, 150);
			addHoverText(39298, "", "1B Tickets (Floor 2)", TDA, 0, 16711680, false, true, 150);
			addHoverText(39299, "", "Ticket Boss", TDA, 0, 16711680, false, true, 150);
	...
	public static void slayertask(TextDrawingArea[] TDA) {
		...
		addButton(48002, 0, "", 105, 50, "Teleports", 1);
		addButton(48089, 0, "", 105, 50, "Private Dicezone", 1);
		addButton(48004, 0, "", 105, 50, "Shops", 1);
	...
	public static void info(TextDrawingArea[] tda) {
		...
		addTextButton(41220, "@or1@Home Page", "Go to Pandemic's homepage", 0xFF981F, false, true, tda, 1, 300);
		addTextButton(41221, "@or1@Forums", "Go to Pandemic's Forums", 0xFF981F, false, true, tda, 1, 300);
		addTextButton(41222, "@or1@Vote", "Vote for Pandemic", 0xFF981F, false, true, tda, 1, 300);
		addTextButton(41223, "@or1@Donate", "Donate to Pandemic", 0xFF981F, false, true, tda, 1, 300);
	...
	// addText(3431, "Waiting For Other Player", 0xffffff, true, true, 52, TDA,
	// 1);
	...
	public static void gambleScreen(TextDrawingArea[] text) {
		RSInterface screen = addInterface(52500);
		addSprite(52501, 0, "Interfaces/g/S");
		addHover(52502, 3, 0, 52503, 1, "Shop/CLOSE", 16, 16, "Close Window");
		addHovered(52503, 2, "Shop/CLOSE", 16, 16, 52504);
		addTextButton(52505, "Accept", "Accept gamble offer", 0x00C000, false, true, text, 1, 120);
		addTextButton(52506, "Accept", "Accept gamble offer", 0x00C000, false, true, text, 1, 120);
		addText(52507, "Gambling With: ", 0xFF981F, true, false, 0, text, 2);
		addText(52508, "Username", 0xFF981F, false, false, 0, text, 2);
		addText(52509, "Your bet: ", 0xFF981F, false, false, 0, text, 2);
		addText(52510, "Username's bet:", 0xFF981F, false, false, 0, text, 2);
		addText(52511, "Gametype:", 0xFF981F, false, false, 0, text, 2);
		addText(52512, "Dice Duel", 0xFF981F, false, false, 0, text, 2);
		addText(52513, "Rules:", 0xFFFFFF, false, false, 0, text, 2);
		addText(52514, "1. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52515, "2. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52516, "3. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52517, "4. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52518, "5. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52519, "6. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52520, "7. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52521, "8. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52522, "9. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52523, "10. Don't be a bitch.", 0xFFFFFF, false, false, 0, text, 2);
		addText(52524, "Waiting for both players.", 0x910000, true, false, 0, text, 2);
		addToItemGroup(addInterface(52525), 4, 5, 7, 7, false, "Remove 1", "Remove 5", "Remove 10", "Remove All",
				"Remove X");
		addToItemGroup(addInterface(52550), 4, 5, 7, 7, false);
		screen.totalChildren(25);
		screen.child(0, 52501, 12, 16);
		screen.child(1, 52502, 472, 24);
		screen.child(2, 52503, 472, 24);
		screen.child(3, 52505, 81, 289);
		screen.child(4, 52506, 388, 289);
		screen.child(5, 52507, 227, 26);
		screen.child(6, 52508, 277, 26);
		screen.child(7, 52509, 42, 62);
		screen.child(8, 52510, 346, 62);
		screen.child(9, 52511, 197, 48);
		screen.child(10, 52512, 267, 48);
		screen.child(11, 52513, 237, 83);
		screen.child(12, 52514, 191, 106);
		screen.child(13, 52515, 191, 123);
		screen.child(14, 52516, 191, 140);
		screen.child(15, 52517, 191, 157);
		screen.child(16, 52518, 191, 174);
		screen.child(17, 52519, 191, 191);
		screen.child(18, 52520, 191, 208);
		screen.child(19, 52521, 191, 225);
		screen.child(20, 52522, 191, 242);
		screen.child(21, 52523, 191, 259);
		screen.child(22, 52524, 251, 289);
		screen.child(23, 52525, 30, 83);
		screen.child(24, 52550, 327, 83);
		// Iventory Overlay Interface
		RSInterface over = addInterface(52600);
		RSInterface overlay = addInterface(52601);
		over.totalChildren(1);
		over.child(0, 52601, 16, 8);
		overlay.width = interfaceCache[3823].width;
		overlay.height = interfaceCache[3823].height;
		overlay.inv = interfaceCache[3823].inv;
		overlay.invStackSizes = interfaceCache[3823].invStackSizes;
		overlay.usableItemInterface = interfaceCache[3823].usableItemInterface;
		overlay.isInventoryInterface = interfaceCache[3823].isInventoryInterface;
		overlay.invSpritePadX = interfaceCache[3823].invSpritePadX;
		overlay.invSpritePadY = interfaceCache[3823].invSpritePadY;
		overlay.spritesX = interfaceCache[3823].spritesX;
		overlay.spritesY = interfaceCache[3823].spritesY;
		overlay.sprites = interfaceCache[3823].sprites;
		overlay.itemActions = new String[] { "Bet 1", "Bet 5", "Bet 10", "Bet All", "Bet X" };
		overlay.type = interfaceCache[3823].type;
	}

	private static void addToItemGroup(RSInterface rsi, int w, int h, int x, int y, boolean invy,
			String... itemActions) {
		rsi.width = w;
		rsi.height = h;
		rsi.inv = new int[w * h];
		...
		rsi.type = 2;
		for (int i = 0; i <= 4; i++) {
			rsi.itemActions[i] = ((itemActions.length - 1) < i || itemActions[i] == null) ? null : itemActions[i];
		}
	}
	...
	public static void Bank(TextDrawingArea wid[]) {
		...
		addText(21022, "", wid, 0, 0xB4965A, true, false);
		setBounds(21022, 473, 42, 19, Interface);
		addText(21023, "", wid, 0, 0xB4965A, true, false);
		setBounds(21023, 473, 57, 20, Interface);
	 ...
	 * addTabInterface(5065); RSInterface list = interfaceCache[5066];
	 * addText(5067, "Friends List", tda, 1, 0xff9933, true, true);
	 * addText(5070, "Add Friend", tda, 0, 0xff9933, false, true); addText(5071,
	 * "Delete Friend", tda, 0, 0xff9933, false, true); addSprite(16126, 4,
	 * "/Friends/SPRITE"); addSprite(16127, 8, "/Friends/SPRITE");
	 * addHoverButton(5068, "/Friends/SPRITE", 6, 72, 32, "Add Friend", 201,
	 * 5072, 1); addHoveredButton(5072, "/Friends/SPRITE", 7, 72, 32, 5073);
	 * addHoverButton(5069, "/Friends/SPRITE", 6, 72, 32, "Delete Friend", 202,
	 * 5074, 1); addHoveredButton(5074, "/Friends/SPRITE", 7, 72, 32, 5075);
	 * tab.totalChildren(11); tab.child(0, 5067, 95, 4); tab.child(1, 16127, 0,
	 * 25); tab.child(2, 16126, 0, 221); tab.child(3, 5066, 0, 24); tab.child(4,
	 * 16126, 0, 22); tab.child(5, 5068, 15, 226); tab.child(6, 5072, 15, 226);
	 * tab.child(7, 5069, 103, 226); tab.child(8, 5074, 103, 226); tab.child(9,
	 * 5070, 25, 237); tab.child(10, 5071, 106, 237); list.height = 196;
	 * list.width = 174; int id = 5092; for(int i = 0; id <= 5191 && i <= 99;
	 * i++) { list.children[i] = id; list.childX[i] = 3; list.childY[i] =
	 * list.childY[i] - 7; id++; }
	 * 
	 * id = 5192; for(int i = 100; id <= 5291 && i <= 199; i++) {
	 * list.children[i] = id; list.childX[i] = 131; list.childY[i] =
	 * list.childY[i] - 7; id++; }
	 * 
	 * }
	 * 
	 * public static void ignoreTab(TextDrawingArea tda[]) { RSInterface tab =
	 * addTabInterface(5715); RSInterface list = interfaceCache[5716];
	 * addText(5717, "Ignore List", tda, 1, 0xff9933, true, true); addText(5720,
	 * "Add Name", tda, 0, 0xff9933, false, true); addText(5721, "Delete Name",
	 * tda, 0, 0xff9933, false, true); addHoverButton(5718, "/Friends/SPRITE",
	 * 6, 72, 32, "Add Name", 501, 5722, 1); addHoveredButton(5722,
	 * "/Friends/SPRITE", 7, 72, 32, 5723); addHoverButton(5719,
	 * "/Friends/SPRITE", 6, 72, 32, "Delete Name", 502, 5724, 1);
	 * addHoveredButton(5724, "/Friends/SPRITE", 7, 72, 32, 5725);
	 * tab.totalChildren(11); tab.child(0, 5717, 95, 4); tab.child(1, 16127, 0,
	 * 25); tab.child(2, 16126, 0, 221); tab.child(3, 5716, 0, 24); tab.child(4,
	 * 16126, 0, 22); tab.child(5, 5718, 15, 226); tab.child(6, 5722, 15, 226);
	 * tab.child(7, 5719, 103, 226); tab.child(8, 5724, 103, 226); tab.child(9,
	 * 5720, 27, 237); tab.child(10, 5721, 108, 237); list.height = 196;
	 * list.width = 174; int id = 5742; for(int i = 0; id <= 5841 && i <= 99;
	 * i++) { list.children[i] = id; list.childX[i] = 3; list.childY[i] =
	 * list.childY[i] - 7; id++; }
	 * 
	 * }
	 ...
	 * "Show Equipment Stats"); //addButton(27654, 2, "Equipment/BOX", "Xp Lock"
	 * , 27657, 1, 40, 39); // removeSomething(19145); removeSomething(19146);
	 * removeSomething(19147); setBounds(19144, 21, 210, 23, Interface);
	 * setBounds(19145, 40, 210, 24, Interface); setBounds(19146, 40, 210, 25,
	 * Interface); setBounds(19147, 40, 210, 26, Interface); RSInterface tab =
	 * addTabInterface(15106); addSprite(15107, 7, "Equipment/CUSTOM");
	 * addHoverButton(15210, "Equipment/CUSTOM", 8, 21, 21, "Close", 250, 15211,
	 * 3); addHoveredButton(15211, "Equipment/CUSTOM", 9, 21, 21, 15212);
	 ...
	 * addText(15114, "Other bonuses", wid, 2, 0xe4a146, false, true); for(int i
	 * = 1675; i <= 1684; i++) textSize(i, wid, 1);
	 * 
