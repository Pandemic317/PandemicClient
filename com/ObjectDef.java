	...
	public static ObjectDef forID(int i) {
		...
		class46.readValues(stream);
				...
				class46.aBoolean769 = false;
					...
					if (i == 11210) {
						class46.name = "Heaven Ps logo"; 
						class46.description = "Its just a logo".getBytes();
						class46.anInt744 = 1;
						class46.anInt761 = 1;
						class46.anIntArray773 = new int[1];
						class46.anIntArray773[0] = 2;
						class46.itemActions = new String[5];
						class46.hasActions = true;
						class46.aBoolean767 = false;
						class46.aBoolean762 = false;
...
if (i == 369) {
				class46.name = "PK Cupboard"; 
				class46.description = "Some say this leads to Narnia ...".getBytes();
				class46.itemActions = new String[5];
				class46.itemActions[0] = "Teleport";
				class46.hasActions = true;
			}

if (i == 6072) {
				class46.name = "EmpirePs Bank"; 
				class46.description = "You can bank here..".getBytes();
				class46.itemActions = new String[5];
				class46.itemActions[0] = "Open Bank";
				class46.hasActions = true;
			}
if (i == 18266) {
	class46.name = "Tzhaar Minigame Entrance"; 
}
if (i == 15755) {
	class46.name = "Hidden Barrows Minigame"; 
}
if (i == 1099) {
				class46.name = "Broken Throne"; 
				class46.description = "Fix it..".getBytes();
				class46.itemActions = new String[5];
				class46.itemActions[0] = "Fix";
				class46.hasActions = true;
			}
if (i == 6073) {
				class46.name = "EmpirePs Bank"; 
...
if (i == 26286) {
	class46.description = "An ancient, powerful altar.".getBytes();
	class46.itemActions = new String[5];
	class46.itemActions[0] = "Pray-at";
	class46.hasActions = true;
}
if (i == 3485) {
	class46.name = "Starting Well";
	class46.description = "A well that will make your starting wishes come true!".getBytes();
}
			...
			if (i == 823) {
				class46.itemActions = new String[5];
				class46.itemActions[0] = "Hit";
				class46.hasActions = true;
			}
			if (i == 822) {
				class46.itemActions = new String[5];
				class46.itemActions[0] = "Lift";
				class46.hasActions = true;
			}
			if (i == 3563) {
				class46.itemActions = new String[5];
			...
			if (i == 1532) {
				class46.name = "Door"; 
				class46.description = "A Door For The Minigame.".getBytes();
				class46.itemActions = new String[5];
			...
			if (i == 13660) {
				class46.name = "Pokéball"; 
				class46.description = "EmpirePs's Pokemon Mini-Game.".getBytes();
				class46.anInt744 = 1;
				class46.anInt761 = 1;
				class46.anIntArray773 = new int[1];
			...
			if (i == 13665) {
				class46.name = "Slot Machine"; 
				class46.description = "EmpirePs's Own Slot Machine!".getBytes();
				class46.anInt744 = 1;
				class46.anInt761 = 1;
				class46.anIntArray773 = new int[1];
				class46.anIntArray773[0] = 52105;
				class46.itemActions = new String[5];
				class46.itemActions[0] = "Spin";
				class46.hasActions = true;
				class46.aBoolean767 = false;
				class46.aBoolean762 = false;
				class46.aBoolean769 = false;
