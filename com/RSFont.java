...
public class RSFont extends DrawingArea {
	...
	public static String handleOldSyntax(String text) {
		...
		text = text.replaceAll("@cr11@", "<img=9>");
		text = text.replaceAll("@cr12@", "<img=10>");
		text = text.replaceAll("@cr13@", "<img=11>");
		text = text.replaceAll("@cr14@", "<img=12>");
		text = text.replaceAll("@cr15@", "<img=13>");
